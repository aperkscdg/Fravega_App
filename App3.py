...
def login(ventana):
    ...
    frame = tk.Frame(ventana, bg="#CE89D4")
    frame.place(x=525, y=400)

    # Etiqueta Nombre
    etiqueta_nombre = tk.Label(frame, text="Nombre",font=("Arial",12) ,bg="#CE89D4", fg="white")
    ...
    # Etiqueta Contraseña
    etiqueta_contraseña = tk.Label(frame, text="Contraseña",font=("Arial",12), bg="#CE89D4", fg="white")
    ...
    # Botón Ingresar
    ingresar_no=Image.open("Imagenes/ingresar.png").convert("RGBA")
    ingresar_red=ingresar_no.resize((150,50))
    imagen_si=ImageTk.PhotoImage(ingresar_red)
    boton_ingresar = tk.Button(frame, image=imagen_si,command=usuario.validar_datos,bg="purple",bd=0)
